[learn-jenkins](../README.md) > ["Router"](../modules/_router_.md) > [AppRouter](../classes/_router_.approuter.md) > [ILayerOptions](../interfaces/_router_.approuter.ilayeroptions.md)
