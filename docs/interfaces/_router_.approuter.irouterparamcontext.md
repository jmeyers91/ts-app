[learn-jenkins](../README.md) > ["Router"](../modules/_router_.md) > [AppRouter](../classes/_router_.approuter.md) > [IRouterParamContext](../interfaces/_router_.approuter.irouterparamcontext.md)
