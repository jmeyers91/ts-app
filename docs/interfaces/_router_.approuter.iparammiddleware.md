[ts-app](../README.md) > ["Router"](../modules/_router_.md) > [AppRouter](../classes/_router_.approuter.md) > [IParamMiddleware](../interfaces/_router_.approuter.iparammiddleware.md)
